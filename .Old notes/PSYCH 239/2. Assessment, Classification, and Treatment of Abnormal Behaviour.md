...
- Cognitive behaviour therapies
	...
	- Beck’s Cognitive Therapy
		- Rational Empiricism: Do experiment to show patient that things aren't as bad as they are, with training on how to, skill building
	- Meichenbaum’s Cognitive-Behavioural Therapy
		- Stress inoculation training
			1. Clients learn how to categorize problems into emotion-focused or problem-focused so that they can better treat their negative situations.
			  2. The client is taught skills that help them cope with their stressors. These skills are then practised in the space of therapy. These skills involve self-regulation, problem-solving, interpersonal communication skills, etc.
			  3. This gives the client opportunities to apply their learned skills to a wide range of stressors. Activities include role-playing, imagery, modeling, etc. 
---
...
- Establishing the superiority of one approach versus another is more problematic
	- Depends on lots of factors including the disorder
		- Depends also on therapist-client *alliance*
	- "Dodo bird effect"
...
- Therapeutic alliance is a necessary condition, 
	...
	- **Quality of the therapeutic alliance is necessary for effective therapy**
	- correlation with outcome typically in range of 0.2
- Other Factors can be:
	- Mobilization of hope
	- attention and support provided by therapist
	- development of **good working alliance**

## Canadian multicultural issues in psychotherapy
- practitioners have become increasingly sensitive to Canada's multicultural makeup
	- training more culturally skilled people
...
- Civil commitment (Psychiatric commitment)
	...
	- Form 1
		...
		- Must be likely to cause hard to themselves or others
		- Unsuitable for admission to a facility other than as a *formal patient*
	- Form 10
		- Done by peace officer
		- same as form 1 but just for a non professional
		- not arresting them
		- able to transport them to hospital for a formal assessment
	- Form 8
		- Same as form 10, done by a judge
		- person goes to court, asks judge to fill it out, gives someone authority to have them moved to hospital for assessment
	- **No one is required to get treatment after these forms**
	- **Person is able to request that they don't fill out form**
- Legal Commitment (NCRMD: Not criminally responsible on account of mental disorder)
	- Clear evidence
	- Imminent risk
	- Limited time
	- *required for being charged for the crime, if they commit the crime but are not sufficiently mentally healthy, they cannot be charged*
		- they did not understand what they were doing
		- could not control behaviours
		- didn't understand they did something wrong
- Community treatment orders (CTOs)
	- Same as Being civilly committed to a facility BUT
	- they are basically on probation
	- we leave them in the community as they have good support there and that would help them more than being in a facility
## Psychiatric Commitment and Patients' rights
- Who is the most dangerous?
- How do we judge danger?
### Predicting Dangerousness
- **Low base rate**: Overpredicting Dangerousness due to inaccurate predictions in general, rare events are difficult to predict
	- Low rate of condition ==> high rate of false positives for danger / relapse / action
- Lower the rate, the more likely danger will be overpredicted
- Psychopathy checklist
- Post Hoc problem
	- We do prediction math model on a specific population, new patient outside of that population is judged based on that model, we can get that wrong and in *post*, realize we made a mistake
	- Unaccounted variables
- Leaping from general to specific
- Unlikelihood of disclosure of direct threats of violence
- Behaviour in community is **much different** than behaviour in facility
### The Insanity Defense
- The M'Naughten rule
	- Dude who had paranoid schizophrenia and thought the only hope he had was to shoot president to stop president's party members to stop staking him
	- Rule: not guilty if insane at time of act
- NGRI (not guilty by reason of insanity)
- R. v. Swain (1991)
	- People cannot just be kept in facility for their entire life and in order to be released they need to demonstrate they are improving
- NCRMD (not criminally responsible on account of mental disorder)
### Competency to stand trial
- Unable to stand trial if:
	- Incapable of participating in their own defense
	- can't distinguish between pleas
	- doesn't understand trial purpose
	- cannot communicate with counsel rationally or make critical decision on counsels advice
	- is unable to take the stand to testify
### Balancing Rights
- Obligation to the public
	- Duty to warn (Tarrasoff ruling)
		- Dude who was obsessive over a woman, reported these feelings to psychologist, the guy was approach, psychologist's boss got mad at psychologist, victim was not told, victim was later killed
		- *You are allowed to break confidentiality, to tell someone that they are in danger*
- Patient's rights
	- Rights to treatment
	- Rights to refuse treatment
		- Form 15 Treatment Order criteria (Obligatory treatment order):
			1. Likely to improve with treatment
			2. Likely to get worse without treatment
			3. Benefits outweigh the risks of treatment
			4. Treatment is the least limiting and invading of all possible measures that meet the first three conditions
				- Least invasive
