...
- Pattern/high risk factor recognition
	...
	- Predictability
		...
		- We can exploit this to help addicts
		- Addicts tend to have behaviours that will often lead to relapse when not pointed out / modified
	...
	- Specific coping strategies
		...
		- avoidance
			...
			- Prevents people from engaging in high risk behaviour
	- Weekly "bring-backs"
		- Review things weekly
		- SUDs
			- Seemingly Unimportant Decisions
			- "On a particular day, i decided to ride my bike to work , and ended up passing by the bar, and ended up drinking"
				- In reality, the person made the decision to bike because they wanted to drink even if it was in the back of their head
				- Pointing out the bad reasoning often causes upset and defensiveness
	- Abstinence Violation Effect
### Chains
- Evaluate how a relapse happened
- 10 rows telling the story of relapse
- Slow accumulation of *risk factors that we can point out and make a relapse prevention plan out of*
- After this scenario, work on coping strategies in order to prevent this relapse
![[Pasted image 20240523170046.png]]
![[Pasted image 20240523170218.png]]
- Left side is only observable behaviour, as if with a camera
- Right side is internal thoughts and feelings during this time
### CONTROLLED DRINKING: Viable option or big mistake?
- Can people with alcoholism be taught to engage in *controlled social drinking*? Original research done in the 70's.
	- *Not encouraging*, **Failure**
	- Improper control procedures however in early research but still large evidence on it
- The contention that people with alcoholism can learn to drink moderately remains controversial.
