	...
	- BPD patients habitually "test" relationships
		...
		- Suicide threats/attempts
			- **Extinction burst**
				...
				- *"When you are on a reinforcement schedule, the tendency to engage in behaviour that usually leads to reinforcement, increases in rate and intensity when the schedule suddenly isn't consistent"*
